...
impl From<myso_sdk_types::TransactionEffects> for TransactionEffects {
    fn from(value: myso_sdk_types::TransactionEffects) -> Self {
        Self::merge_from(&value, &FieldMaskTree::new_wildcard())
    }
}

impl Merge<&myso_sdk_types::TransactionEffects> for TransactionEffects {
    fn merge(&mut self, source: &myso_sdk_types::TransactionEffects, mask: &FieldMaskTree) {
        ...
        match source {
            myso_sdk_types::TransactionEffects::V1(v1) => self.merge(v1.as_ref(), mask),
            myso_sdk_types::TransactionEffects::V2(v2) => self.merge(v2.as_ref(), mask),
        }
    }
}
...
impl TryFrom<&TransactionEffects> for myso_sdk_types::TransactionEffects {
...
impl Merge<&myso_sdk_types::TransactionEffectsV1> for TransactionEffects {
    fn merge(
        &mut self,
        myso_sdk_types::TransactionEffectsV1 {
            status,
            epoch,
            gas_used,
...
impl Merge<&myso_sdk_types::TransactionEffectsV2> for TransactionEffects {
    fn merge(
        &mut self,
        myso_sdk_types::TransactionEffectsV2 {
            status,
            epoch,
            gas_used,
            transaction_digest,
...
impl From<myso_sdk_types::ChangedObject> for ChangedObject {
    fn from(value: myso_sdk_types::ChangedObject) -> Self {
        ...
        let input_state = match value.input_state {
            myso_sdk_types::ObjectIn::NotExist => InputObjectState::DoesNotExist,
            myso_sdk_types::ObjectIn::Exist {
                version,
                digest,
                owner,
            } => {
        ...
        let output_state = match value.output_state {
            myso_sdk_types::ObjectOut::NotExist => OutputObjectState::DoesNotExist,
            myso_sdk_types::ObjectOut::ObjectWrite { digest, owner } => {
                message.output_digest = Some(digest.to_string());
                message.output_owner = Some(owner.into());
                OutputObjectState::ObjectWrite
            }
            myso_sdk_types::ObjectOut::PackageWrite { version, digest } => {
                message.output_version = Some(version);
                message.output_digest = Some(digest.to_string());
                OutputObjectState::PackageWrite
            }
            myso_sdk_types::ObjectOut::AccumulatorWrite(accumulator_write) => {
...
impl TryFrom<&ChangedObject> for myso_sdk_types::ChangedObject {
    type Error = TryFromProtoError;
    ...
    fn try_from(value: &ChangedObject) -> Result<Self, Self::Error> {
        ...
        let input_state = match value.input_state() {
            ...
            InputObjectState::DoesNotExist => myso_sdk_types::ObjectIn::NotExist,
            InputObjectState::Exists => myso_sdk_types::ObjectIn::Exist {
                version: value
                    .input_version
        ...
        let output_state = match value.output_state() {
            ...
            OutputObjectState::DoesNotExist => myso_sdk_types::ObjectOut::NotExist,
            OutputObjectState::ObjectWrite => myso_sdk_types::ObjectOut::ObjectWrite {
                digest: value
                    .output_digest
                    .as_ref()
                    .ok_or_else(|| TryFromProtoError::missing("digest"))?
            ...
            OutputObjectState::PackageWrite => myso_sdk_types::ObjectOut::PackageWrite {
                version: value
                    .output_version
                    .ok_or_else(|| TryFromProtoError::missing("version"))?,
                digest: value
            ...
            OutputObjectState::AccumulatorWrite => myso_sdk_types::ObjectOut::AccumulatorWrite(
                value
...
impl From<myso_sdk_types::IdOperation> for changed_object::IdOperation {
    fn from(value: myso_sdk_types::IdOperation) -> Self {
        use myso_sdk_types::IdOperation::*;
...
impl TryFrom<changed_object::IdOperation> for myso_sdk_types::IdOperation {
    type Error = TryFromProtoError;
...
impl From<myso_sdk_types::AccumulatorWrite> for AccumulatorWrite {
    fn from(value: myso_sdk_types::AccumulatorWrite) -> Self {
        ...
        message.set_operation(match value.operation() {
            myso_sdk_types::AccumulatorOperation::Merge => AccumulatorOperation::Merge,
            myso_sdk_types::AccumulatorOperation::Split => AccumulatorOperation::Split,
...
impl TryFrom<&AccumulatorWrite> for myso_sdk_types::AccumulatorWrite {
    type Error = TryFromProtoError;
...
impl From<myso_sdk_types::UnchangedConsensusObject> for UnchangedConsensusObject {
    fn from(value: myso_sdk_types::UnchangedConsensusObject) -> Self {
        use myso_sdk_types::UnchangedConsensusKind::*;
...
impl TryFrom<&UnchangedConsensusObject> for myso_sdk_types::UnchangedConsensusObject {
    type Error = TryFromProtoError;
