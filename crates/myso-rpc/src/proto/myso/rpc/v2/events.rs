...
impl From<myso_sdk_types::Event> for Event {
    fn from(value: myso_sdk_types::Event) -> Self {
        Self::merge_from(value, &FieldMaskTree::new_wildcard())
    }
}

impl Merge<myso_sdk_types::Event> for Event {
    fn merge(&mut self, source: myso_sdk_types::Event, mask: &FieldMaskTree) {
...
impl TryFrom<&Event> for myso_sdk_types::Event {
...
impl From<myso_sdk_types::TransactionEvents> for TransactionEvents {
    fn from(value: myso_sdk_types::TransactionEvents) -> Self {
        Self::merge_from(value, &FieldMaskTree::new_wildcard())
    }
}

impl Merge<myso_sdk_types::TransactionEvents> for TransactionEvents {
    fn merge(&mut self, source: myso_sdk_types::TransactionEvents, mask: &FieldMaskTree) {
...
impl TryFrom<&TransactionEvents> for myso_sdk_types::TransactionEvents {
    type Error = TryFromProtoError;
