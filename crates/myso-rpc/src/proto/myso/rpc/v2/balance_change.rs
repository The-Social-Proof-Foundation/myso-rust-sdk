...
impl From<myso_sdk_types::BalanceChange> for BalanceChange {
    fn from(value: myso_sdk_types::BalanceChange) -> Self {
        Self {
...
impl Merge<&myso_sdk_types::BalanceChange> for BalanceChange {
    fn merge(&mut self, source: &myso_sdk_types::BalanceChange, mask: &crate::field::FieldMaskTree) {
...
impl TryFrom<&BalanceChange> for myso_sdk_types::BalanceChange {
