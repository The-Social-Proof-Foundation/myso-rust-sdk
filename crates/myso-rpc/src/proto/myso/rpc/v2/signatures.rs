...
impl From<myso_sdk_types::ValidatorAggregatedSignature> for ValidatorAggregatedSignature {
    fn from(value: myso_sdk_types::ValidatorAggregatedSignature) -> Self {
...
impl TryFrom<&ValidatorAggregatedSignature> for myso_sdk_types::ValidatorAggregatedSignature {
    ...
    fn try_from(value: &ValidatorAggregatedSignature) -> Result<Self, Self::Error> {
        ...
        let signature = value
            ...
            .as_ref()
            .pipe(myso_sdk_types::Bls12381Signature::from_bytes)
            .map_err(|e| {
                TryFromProtoError::invalid(ValidatorAggregatedSignature::SIGNATURE_FIELD, e)
            })?;
        let bitmap = myso_sdk_types::Bitmap::deserialize_from(value.bitmap()).map_err(|e| {
...
impl From<myso_sdk_types::ValidatorCommitteeMember> for ValidatorCommitteeMember {
    fn from(value: myso_sdk_types::ValidatorCommitteeMember) -> Self {
        Self {
...
impl TryFrom<&ValidatorCommitteeMember> for myso_sdk_types::ValidatorCommitteeMember {
    type Error = TryFromProtoError;
...
impl From<myso_sdk_types::ValidatorCommittee> for ValidatorCommittee {
    fn from(value: myso_sdk_types::ValidatorCommittee) -> Self {
        Self {
            epoch: Some(value.epoch),
...
impl TryFrom<&ValidatorCommittee> for myso_sdk_types::ValidatorCommittee {
    type Error = TryFromProtoError;
...
impl From<myso_sdk_types::CircomG1> for CircomG1 {
    fn from(value: myso_sdk_types::CircomG1) -> Self {
...
impl TryFrom<&CircomG1> for myso_sdk_types::CircomG1 {
    type Error = TryFromProtoError;
...
impl From<myso_sdk_types::CircomG2> for CircomG2 {
    fn from(value: myso_sdk_types::CircomG2) -> Self {
...
impl TryFrom<&CircomG2> for myso_sdk_types::CircomG2 {
    type Error = TryFromProtoError;
...
impl From<myso_sdk_types::ZkLoginClaim> for ZkLoginClaim {
    fn from(
        myso_sdk_types::ZkLoginClaim { value, index_mod_4 }: myso_sdk_types::ZkLoginClaim,
    ) -> Self {
        Self {
            value: Some(value),
...
impl TryFrom<&ZkLoginClaim> for myso_sdk_types::ZkLoginClaim {
    type Error = TryFromProtoError;
...
impl From<myso_sdk_types::ZkLoginProof> for ZkLoginProof {
    fn from(value: myso_sdk_types::ZkLoginProof) -> Self {
        Self {
            a: Some(value.a.into()),
            b: Some(value.b.into()),
            c: Some(value.c.into()),
...
impl TryFrom<&ZkLoginProof> for myso_sdk_types::ZkLoginProof {
    type Error = TryFromProtoError;
...
impl From<myso_sdk_types::ZkLoginInputs> for ZkLoginInputs {
    fn from(value: myso_sdk_types::ZkLoginInputs) -> Self {
        Self {
...
impl TryFrom<&ZkLoginInputs> for myso_sdk_types::ZkLoginInputs {
    type Error = TryFromProtoError;
...
impl From<myso_sdk_types::ZkLoginAuthenticator> for ZkLoginAuthenticator {
    fn from(value: myso_sdk_types::ZkLoginAuthenticator) -> Self {
...
impl TryFrom<&ZkLoginAuthenticator> for myso_sdk_types::ZkLoginAuthenticator {
    type Error = TryFromProtoError;
...
impl From<&myso_sdk_types::ZkLoginPublicIdentifier> for ZkLoginPublicIdentifier {
    fn from(value: &myso_sdk_types::ZkLoginPublicIdentifier) -> Self {
        Self {
...
impl TryFrom<&ZkLoginPublicIdentifier> for myso_sdk_types::ZkLoginPublicIdentifier {
    type Error = TryFromProtoError;
...
impl TryFrom<&SignatureScheme> for myso_sdk_types::SignatureScheme {
    type Error = TryFromProtoError;
...
impl From<myso_sdk_types::SimpleSignature> for SimpleSignature {
    fn from(value: myso_sdk_types::SimpleSignature) -> Self {
        let (signature, public_key) = match &value {
            myso_sdk_types::SimpleSignature::Ed25519 {
                signature,
                public_key,
            } => (signature.as_bytes(), public_key.as_bytes()),
            myso_sdk_types::SimpleSignature::Secp256k1 {
                signature,
                public_key,
            } => (signature.as_bytes(), public_key.as_bytes()),
            myso_sdk_types::SimpleSignature::Secp256r1 {
                signature,
                public_key,
            } => (signature.as_bytes(), public_key.as_bytes()),
...
impl TryFrom<&SimpleSignature> for myso_sdk_types::SimpleSignature {
    type Error = TryFromProtoError;
...
impl From<myso_sdk_types::PasskeyAuthenticator> for PasskeyAuthenticator {
    fn from(value: myso_sdk_types::PasskeyAuthenticator) -> Self {
        Self {
...
impl TryFrom<&PasskeyAuthenticator> for myso_sdk_types::PasskeyAuthenticator {
    type Error = TryFromProtoError;
...
impl From<&myso_sdk_types::MultisigMemberPublicKey> for MultisigMemberPublicKey {
    fn from(value: &myso_sdk_types::MultisigMemberPublicKey) -> Self {
...
impl TryFrom<&MultisigMemberPublicKey> for myso_sdk_types::MultisigMemberPublicKey {
    type Error = TryFromProtoError;
    ...
    fn try_from(value: &MultisigMemberPublicKey) -> Result<Self, Self::Error> {
        ...
        match value.scheme() {
            ...
            SignatureScheme::Passkey => Self::Passkey(myso_sdk_types::PasskeyPublicKey::new(
...
impl From<&myso_sdk_types::MultisigMember> for MultisigMember {
    fn from(value: &myso_sdk_types::MultisigMember) -> Self {
        Self {
...
impl TryFrom<&MultisigMember> for myso_sdk_types::MultisigMember {
    type Error = TryFromProtoError;
...
impl From<&myso_sdk_types::MultisigCommittee> for MultisigCommittee {
    fn from(value: &myso_sdk_types::MultisigCommittee) -> Self {
        Self {
...
impl TryFrom<&MultisigCommittee> for myso_sdk_types::MultisigCommittee {
    type Error = TryFromProtoError;
...
impl From<&myso_sdk_types::MultisigMemberSignature> for MultisigMemberSignature {
    fn from(value: &myso_sdk_types::MultisigMemberSignature) -> Self {
...
impl TryFrom<&MultisigMemberSignature> for myso_sdk_types::MultisigMemberSignature {
    type Error = TryFromProtoError;
...
impl From<&myso_sdk_types::MultisigAggregatedSignature> for MultisigAggregatedSignature {
    fn from(value: &myso_sdk_types::MultisigAggregatedSignature) -> Self {
        Self {
...
impl TryFrom<&MultisigAggregatedSignature> for myso_sdk_types::MultisigAggregatedSignature {
    type Error = TryFromProtoError;
    ...
    fn try_from(value: &MultisigAggregatedSignature) -> Result<Self, Self::Error> {
        ...
        if let Some(legacy_bitmap) = value.legacy_bitmap_opt() {
            let legacy_bitmap =
                myso_sdk_types::Bitmap::deserialize_from(legacy_bitmap).map_err(|e| {
...
impl From<myso_sdk_types::UserSignature> for UserSignature {
    fn from(value: myso_sdk_types::UserSignature) -> Self {
        Self::merge_from(value, &FieldMaskTree::new_wildcard())
    }
}

impl Merge<myso_sdk_types::UserSignature> for UserSignature {
    fn merge(&mut self, source: myso_sdk_types::UserSignature, mask: &FieldMaskTree) {
...
impl TryFrom<&UserSignature> for myso_sdk_types::UserSignature {
    type Error = TryFromProtoError;
