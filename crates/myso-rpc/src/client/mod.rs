...
use crate::proto::myso::rpc::v2::ledger_service_client::LedgerServiceClient;
use crate::proto::myso::rpc::v2::move_package_service_client::MovePackageServiceClient;
use crate::proto::myso::rpc::v2::signature_verification_service_client::SignatureVerificationServiceClient;
use crate::proto::myso::rpc::v2::state_service_client::StateServiceClient;
use crate::proto::myso::rpc::v2::subscription_service_client::SubscriptionServiceClient;
use crate::proto::myso::rpc::v2::transaction_execution_service_client::TransactionExecutionServiceClient;
...
impl Client {
    ...
    pub const MAINNET_FULLNODE: &str = "https://fullnode.mainnet.mysocial.network";

    /// URL for the public-good, MySo Foundation provided fullnodes for testnet.
    pub const TESTNET_FULLNODE: &str = "https://fullnode.testnet.mysocial.network";

    /// URL for the public-good, MySo Foundation provided fullnodes for devnet.
    pub const DEVNET_FULLNODE: &str = "https://fullnode.devnet.mysocial.network";

    /// URL for the public-good, MySo Foundation provided archive for mainnet.
    pub const MAINNET_ARCHIVE: &str = "https://archive.mainnet.mysocial.network";

    /// URL for the public-good, MySo Foundation provided archive for testnet.
    pub const TESTNET_ARCHIVE: &str = "https://archive.testnet.mysocial.network";
