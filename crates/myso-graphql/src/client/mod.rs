...
impl Client {
    ...
    ///
    /// let client = Client::new("https://graphql.testnet.mysocial.network/graphql").unwrap();
    /// ```
    ...
    ///
    /// #[tokio::main]
    /// async fn main() -> Result<(), myso_graphql::Error> {
    ///     let client = Client::new("https://graphql.testnet.mysocial.network/graphql")?;
    ///     let response = client
