...
use myso_sdk_types::TransactionEffects;
...
/// A balance change from a transaction (re-exported from myso-rpc).
pub use myso_rpc::proto::myso::rpc::v2::BalanceChange;
...
impl Client {
    ...
    ///
    /// let client = Client::new("https://graphql.mainnet.mysocial.network/graphql")?;
