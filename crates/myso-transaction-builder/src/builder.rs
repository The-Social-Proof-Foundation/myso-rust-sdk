...
pub(crate) enum ResolvedArgument {
    ...
    Resolved(myso_sdk_types::Argument),
}
...
impl TransactionBuilder {
    ...
    pub fn try_build(mut self) -> Result<Transaction, Error> {
        ...
        // Gas payment
        let gas_payment = myso_sdk_types::GasPayment {
            objects: self
                .gas
                .iter()
        ...
        for (id, input) in unresolved_inputs {
            let arg = match input {
                InputArg::Gas => myso_sdk_types::Argument::Gas,
                InputArg::Pure(value) => {
                    resolved_inputs.push(myso_sdk_types::Input::Pure(value));
                    myso_sdk_types::Argument::Input(resolved_inputs.len() as u16 - 1)
                }
        ...
        for (id, command) in self.commands {
            ...
            let arg = myso_sdk_types::Argument::Result(resolved_commands.len() as u16 - 1);

            *self.arguments.get_mut(&id).unwrap() = ResolvedArgument::Resolved(arg);
        }

        Ok(Transaction {
            kind: myso_sdk_types::TransactionKind::ProgrammableTransaction(
                myso_sdk_types::ProgrammableTransaction {
    ...
    #[cfg(feature = "intents")]
    #[cfg_attr(doc_cfg, doc(cfg(feature = "intents")))]
    pub async fn build(mut self, client: &mut myso_rpc::Client) -> Result<Transaction, Error> {
...
impl Argument {
    ...
    ) -> Result<myso_sdk_types::Argument, Result<usize, Error>> {
    ...
    fn try_resolve_many(
        arguments: &[Self],
        resolved_arguments: &BTreeMap<usize, ResolvedArgument>,
    ) -> Result<Vec<myso_sdk_types::Argument>, Result<usize, Error>> {
        arguments
            .iter()
...
impl Command {
    fn try_resolve(
        &self,
        resolved_arguments: &BTreeMap<usize, ResolvedArgument>,
    ) -> Result<myso_sdk_types::Command, Result<usize, Error>> {
        use myso_sdk_types::Command as C;
        ...
        let cmd = match &self.kind {
            CommandKind::MoveCall(MoveCall {
                ...
                type_arguments,
                arguments,
            }) => C::MoveCall(myso_sdk_types::MoveCall {
                package: *package,
            ...
            CommandKind::TransferObjects(TransferObjects { objects, address }) => {
                C::TransferObjects(myso_sdk_types::TransferObjects {
            ...
            CommandKind::SplitCoins(SplitCoins { coin, amounts }) => {
                C::SplitCoins(myso_sdk_types::SplitCoins {
            ...
            CommandKind::MergeCoins(MergeCoins {
                coin,
                coins_to_merge,
            }) => C::MergeCoins(myso_sdk_types::MergeCoins {
                coin: coin.try_resolve(resolved_arguments)?,
            ...
            CommandKind::Upgrade(Upgrade {
                ...
                package,
                ticket,
            }) => C::Upgrade(myso_sdk_types::Upgrade {
                modules: modules.to_owned(),
                dependencies: dependencies.to_owned(),
                package: *package,
...
impl From<&myso_sdk_types::Object> for ObjectInput {
    fn from(object: &myso_sdk_types::Object) -> Self {
        let input = Self::new(object.object_id())
            .with_version(object.version())
            .with_digest(object.digest());

        match object.owner() {
            myso_sdk_types::Owner::Address(_) => input.as_owned(),
            myso_sdk_types::Owner::Object(_) => input,
            myso_sdk_types::Owner::Shared(version) => input.with_version(*version).as_shared(),
            myso_sdk_types::Owner::Immutable => input.as_immutable(),
            myso_sdk_types::Owner::ConsensusAddress { start_version, .. } => {
...
// impl TryFrom<&myso_rpc::proto::myso::rpc::v2::Object> for ObjectInput {
//     type Error = myso_rpc::proto::TryFromProtoError;

//     fn try_from(object: &myso_rpc::proto::myso::rpc::v2::Object) -> Result<Self, Self::Error> {
//         todo!()
//     }
// }
...
// private conversions
impl ObjectInput {
    fn try_into_object_reference(&self) -> Result<myso_sdk_types::ObjectReference, Error> {
        if matches!(self.kind, Some(ObjectKind::ImmutableOrOwned) | None)
            && let Some(version) = self.version
            && let Some(digest) = self.digest
        {
            Ok(myso_sdk_types::ObjectReference::new(
                self.object_id,
                version,
                digest,
            ))
    ...
    fn try_into_input(&self) -> Result<myso_sdk_types::Input, Error> {
        let input = match self {
            ...
            | Self {
                ...
                digest: Some(digest),
                mutable: None,
            } => myso_sdk_types::Input::ImmutableOrOwned(myso_sdk_types::ObjectReference::new(
            ...
            Self {
                ...
                digest: Some(digest),
                ..
            } => myso_sdk_types::Input::Receiving(myso_sdk_types::ObjectReference::new(
                *object_id, *version, *digest,
            )),
            ...
            | Self {
                ...
                digest: None,
                mutable: Some(mutable),
            } => myso_sdk_types::Input::Shared(myso_sdk_types::SharedInput::new(
    ...
    #[cfg(feature = "intents")]
    fn to_input_proto(&self) -> myso_rpc::proto::myso::rpc::v2::Input {
        use myso_rpc::proto::myso::rpc::v2::input::InputKind;

        let mut input =
            myso_rpc::proto::myso::rpc::v2::Input::default().with_object_id(self.object_id);
        match self.kind {
    ...
    fn try_into_object_reference_proto(
        &self,
    ) -> Result<myso_rpc::proto::myso::rpc::v2::ObjectReference, Error> {
        if !matches!(self.kind, Some(ObjectKind::ImmutableOrOwned) | None) {
            return Err(Error::WrongGasObject);
        }

        let mut input =
            myso_rpc::proto::myso::rpc::v2::ObjectReference::default().with_object_id(self.object_id);
        if let Some(version) = self.version {
            input.set_version(version);
        }
        if let Some(digest) = self.digest {
    ...
    pub(crate) fn try_from_object_proto(
        object: &myso_rpc::proto::myso::rpc::v2::Object,
    ) -> Result<Self, Error> {
